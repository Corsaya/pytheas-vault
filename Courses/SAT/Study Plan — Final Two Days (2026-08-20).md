...
## The one number that should reorder your priorities
...
Two-thirds of the loss is R&W, and only 3 of those 18 are grammar. **Study reading, not
grammar** — which is the opposite of what the last three weeks assumed.
...
- **Don't take another full-length test.** There's no time to review one properly, and an
  unreviewed test teaches nothing. [[Test Day Execution]] is explicit about this.
- **Don't re-read the crash courses.** They're a reference library now, not a study list.
- **Don't drill Math broadly.** 9 misses out of 44, two of which were arithmetic. Math is not
  where your points are.
- **Don't study Friday night.** Sleep is worth more than any of the above.
